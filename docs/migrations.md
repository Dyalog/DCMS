...
Migrations are `.sql` files in the `sql` directory. Each numbered migration is applied to the database, in ascending numerical order, from the last migration recorded in the `migrations` table in the database.
